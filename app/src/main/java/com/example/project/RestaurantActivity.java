...
public class RestaurantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load("http://githubbers.com/vissanuck/images/"+restid+".jpg")
                .fit().into(imgRest);
    ...
    private void showFoodDetail(int p) {
        ...
        Picasso.with(this).load("http://githubbers.com/vissanuck/drinkimages/"+foodid+".jpg")
                .memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE)
                .fit().into(imgfood);
        myDialogWindow.show();
    }
    ...
    private void insertCart(final String foodid, final String foodname, final String fquan, final String foodprice) {
        class InsertCart extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("http://githubbers.com/vissanuck/insert_cart.php",hashMap);
                return s;
            }
    ...
    private void loadFoods(final String restid) {
        class LoadFood extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = requestHandler.sendPostRequest("http://githubbers.com/vissanuck/drinks.php",hashMap);
                return s;
            }
            @Override
            protected void onPostExecute(String s) {
