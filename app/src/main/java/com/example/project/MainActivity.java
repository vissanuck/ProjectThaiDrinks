        ...
        class LoadRestaurant extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest
                        ("http://githubbers.com/vissanuck/restaurant.php",hashMap);
                return s;
            }
    ...
    private void loadHistoryOrderData() {
        class LoadOrderData extends AsyncTask<Void,String,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("http://githubbers.com/vissanuck/load_order_history.php",hashMap);
                return s;
            }
    ...
    private void deleteCartFood(final int position) {
        class DeleteCartFood extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = requestHandler.sendPostRequest("http://githubbers.com/vissanuck/delete_cart.php",hashMap);
                return s;
            }
            @Override
            protected void onPostExecute(String s) {
    ...
    private void loadCartData() {
        class LoadCartData extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                hashMap.put("userid",phone);
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("http://githubbers.com/vissanuck/load_cart.php",hashMap);
                return s;
            }
